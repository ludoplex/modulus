...
def compl_mul1d_fwd(
    ...
    return torch.view_as_real(resc)
...
def _contract_diagonal_real(
    ...
    Performs a complex convolution operation between two tensors 'a' and 'b'
    """
    return torch.einsum("bixys,ioxy->boxys", a, b).contiguous()
...
def _contract_dhconv_real(
    ...
    Performs a complex convolution operation between two tensors 'a' and 'b'
    """
    return torch.einsum("bixys,iox->boxys", a, b).contiguous()
...
def _contract_sep_diagonal_real(
    ...
    Performs a complex convolution operation between two tensors 'a' and 'b'
    """
    return torch.einsum("bixys,ixy->boxys", a, b).contiguous()
...
def _contract_sep_dhconv_real(
    ...
    Performs a complex convolution operation between two tensors 'a' and 'b'
    """
    return torch.einsum("bixys,ix->boxys", a, b).contiguous()
